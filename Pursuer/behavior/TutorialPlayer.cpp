...
///</summary>
ID3D12Device* TutorialPlayer::device = nullptr;
Camera* TutorialPlayer::camera = nullptr;

ComPtr<ID3D12RootSignature> TutorialPlayer::rootsignature;
ComPtr<ID3D12PipelineState> TutorialPlayer::pipelinestate;
...
void TutorialPlayer::Initialize()
{
	...
	TutorialPlayer::CreateGraphicsPipeline();
...
void TutorialPlayer::CreateGraphicsPipeline()
{
...
void TutorialPlayer::Draw(ID3D12GraphicsCommandList* cmdList)
{
	// Return if no model
	if (model == nullptr)
	{
...
void TutorialPlayer::PlayAnimation()
{
