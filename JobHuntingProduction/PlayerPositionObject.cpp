...
PlayerPositionObject* PlayerPositionObject::Create(Model* model)
{
	...
	PlayerPositionObject* instance = new PlayerPositionObject();
	if (instance == nullptr) {
		return nullptr;
	}
...
bool PlayerPositionObject::Initialize()
{
...
void PlayerPositionObject::Update()
{
	...
	// クエリーコールバッククラス
	class PlayerPositionObjectQueryCallback : public QueryCallback
	{
	public:
		PlayerPositionObjectQueryCallback(Sphere* sphere) : sphere(sphere) {};
	...
	PlayerPositionObjectQueryCallback callback(sphereCollider);
...
void PlayerPositionObject::OnCollision(const CollisionInfo& info)
{
